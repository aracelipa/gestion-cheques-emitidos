...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="card">
            <form action="{{ route('usuarios.update', $usuario->id_usuario) }}" method="POST" class="form-principal">
                @csrf
                @method('PUT')
                ...
                <input type="text" name="nickname" id="nickname" value="{{ old('nickname', $usuario->nickname) }}" required>
