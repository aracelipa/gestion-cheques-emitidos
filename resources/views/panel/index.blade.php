        ...
        <div class="grid">
            @if(session('usuario_rol') === 'Operador')
                <div class="card">
                    ...
                    <a href="{{ route('cheques.index') }}" class="btn">Ir a Cheques</a>
                </div>
            @endif
            ...
            @if(session('usuario_rol') === 'Supervisor')
                ...
                <div class="card">
                    ...
                    <a href="{{ route('bitacoras.index') }}" class="btn">Ver Bitácora</a>
                </div>

                <div class="card">
                    <h2>Notificaciones</h2>
                    <p>Revise y gestione las notificaciones pendientes del sistema.</p>
                    <a href="{{ route('notificaciones.index') }}" class="btn">Ver Notificaciones</a>
                </div>

                <div class="card">
                    <h2>Reportes</h2>
                    <p>Consulte reportes por estado, beneficiario, banco y fecha de vencimiento.</p>
                    <a href="{{ route('reportes.index') }}" class="btn">Ver Reportes</a>
                </div>
            @endif
