    ...
    <div class="navbar-contenedor">
        <div class="navbar-izquierda">
            <a href="{{ route('panel.index') }}"
               class="navbar-brand {{ request()->routeIs('panel.index') ? 'activo' : '' }}">
                Gestión de Cheques
            </a>
            ...
            <div class="navbar-links">
                @if(in_array(session('usuario_rol'), ['Operador', 'Supervisor']))
                    <a href="{{ route('cheques.index') }}"
                       class="navbar-link {{ request()->routeIs('cheques.*') ? 'activo' : '' }}">
                        Cheques
                    </a>
                @endif
                ...
                @if(session('usuario_rol') === 'Supervisor')
                    <a href="{{ route('bitacoras.index') }}"
                       class="navbar-link {{ request()->routeIs('bitacoras.*') ? 'activo' : '' }}">
                        Bitácora
                    </a>

                    <a href="{{ route('notificaciones.index') }}"
                       class="navbar-link {{ request()->routeIs('notificaciones.*') ? 'activo' : '' }}">
                        Notificaciones
                    </a>

                    <a href="{{ route('reportes.index') }}"
                       class="navbar-link {{ request()->routeIs('reportes.*') ? 'activo' : '' }}">
                        Reportes
                    </a>
                @endif
                ...
                @if(session('usuario_rol') === 'Administrador')
                    <a href="{{ route('usuarios.index') }}"
                       class="navbar-link {{ request()->routeIs('usuarios.*') ? 'activo' : '' }}">
                        Usuarios
                    </a>
                @endif
            </div>
        ...
        <div class="navbar-derecha">
            <div class="navbar-usuario">
                <strong>Usuario:</strong> {{ session('usuario_nombre') }} |
                <strong>Rol:</strong> {{ session('usuario_rol') }}
            </div>
