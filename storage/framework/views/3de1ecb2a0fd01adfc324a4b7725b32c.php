    ...
    <div class="contenedor">
        ...
        <div class="acciones-superiores">
            <?php if(session('usuario_rol') === 'Operador'): ?>
                <a href="<?php echo e(route('cheques.create')); ?>" class="btn">Nuevo Cheque</a>
            <?php endif; ?>

            <?php if(session('usuario_rol') === 'Supervisor'): ?>
                <a href="<?php echo e(route('bitacoras.index')); ?>" class="btn-secondary">Ver Bitácora</a>
            <?php endif; ?>

            <?php if(session('usuario_rol') === 'Administrador'): ?>
                <a href="<?php echo e(route('usuarios.index')); ?>" class="btn-secondary">Gestión de Usuarios</a>
            <?php endif; ?>
        </div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $cheques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cheque): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="acciones">
                                <a href="<?php echo e(route('cheques.show', $cheque->id_cheque)); ?>" class="btn-secondary">Ver</a>

                                <?php if(in_array(session('usuario_rol'), ['Operador', 'Supervisor'])): ?>
                                    <a href="<?php echo e(route('cheques.edit', $cheque->id_cheque)); ?>" class="btn-edit">Editar</a>
                                <?php endif; ?>

                                <?php if(session('usuario_rol') === 'Supervisor'): ?>
                                    <form action="<?php echo e(route('cheques.destroy', $cheque->id_cheque)); ?>" method="POST" onsubmit="return confirm('¿Eliminar este cheque?')">
                                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\arace\OneDrive\Documentos\7mo semestre\Proyecto de grado\gest-cheq-app\resources\views/cheques/index.blade.php ENDPATH**/ ?>